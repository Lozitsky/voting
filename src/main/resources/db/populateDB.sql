...
INSERT INTO dishes (name, price, restaurant_id, date)VALUES
       ('Завтрак', 500, 10004, '2018-09-15'),
       ('Обед', 1000, 10004, '2018-09-15'),
       ('Ужин', 500, 10005, '2018-09-15'),
       ('Завтрак', 500, 10005, '2018-09-15'),
       ('Обед', 1000, 10006, DEFAULT ),
       ('Ужин', 510, 10006, '2018-09-15'),
       ('Super ланч', 510, 10005, '2018-09-15'),
       ('Super ужин', 1500, 10005, '2018-09-15'),
       ('Завтрак2', 500, 10007, '2018-09-15');
