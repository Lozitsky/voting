...
INSERT INTO dishes (name, price, restaurant_id, date)VALUES
       ('Завтрак', 500, 10004, '2018-09-18'),
       ('Обед', 1000, 10004, '2018-09-18'),
       ('Ужин', 500, 10005, '2018-09-18'),
       ('Завтрак', 500, 10005, '2018-09-18'),
       ('Обед', 1000, 10006, '2018-09-18'),
       ('Ужин', 510, 10006, '2018-09-18'),
       ('Super ланч', 510, 10005, '2018-09-18'),
       ('Super ужин', 1500, 10005, '2018-09-18');
